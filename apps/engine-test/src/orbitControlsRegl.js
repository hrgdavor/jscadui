...
/**
  ...
  * @param {Object} controls the controls data/state
  * @param {Object} camera the camera data/state
  * @param {Object} bounds - bounds of the objects that we are fitting on the screen
  * @return {Object} the updated camera data/state
*/
export const zoomToFit = ({ controls, camera, bounds }) => {
  ...
  if (!bounds) return { controls, camera }
