...
const main = () => {
    ...
    const foil2 = profiles.foils2d.trefoil({ radius: 10, lobeRadiusType: 'inSlice' });
    layout.addToLayout({ name: 'foil2', desc: '...', layoutOpts }, foil2);

    const foil3 = profiles.foils2d.trefoil({ radius: 10, lobeRadiusType: 'halfRadius' });
    layout.addToLayout({ name: 'foil3', desc: '...', layoutOpts }, foil3);

    const foil4 = profiles.foils2d.quatrefoil({ radius: 10 });
    ...
    const foil6 = profiles.foils2d.quatrefoil({ radius: 10, lobeRadiusType: 'halfRadius' });
