...
const { prefab, profiles } = swJscad.models;
...
const main = () => {
    ...
    const mould1 = prefab.mouldings.cuboidMouldingOneEdge({ size: [20, 40, 8] }, circNotchprofile);
    ...
    const mould2 = prefab.mouldings.cuboidMoulding({ size: [10, 40, 8] }, circNotchprofile);
    ...
    const mould3 = prefab.mouldings.circularMoulding({ radius: 20, height: 8 }, circProtProfile);
    ...
    const mould4 = prefab.mouldings.circularMoulding({ segments: 8, radius: 20, height: 8 }, circProtProfile);
